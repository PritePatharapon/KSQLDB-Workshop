...
- [Basic standing concept on ksqlDB](#basic-standing-concept-on-ksqldb)
- [ksqlDB Data pipeline](#ksqldb-data-pipeline)
- [Operations & Monitoring](#operations--monitoring)

## Overview
ksqlDB is a stream processing applications on top of Apache Kafka. It is **distributed**, **scalable**, **reliable**, and **real-time**. ksqlDB combines the power of real-time stream processing with the approachable feel of a relational database through a familiar, lightweight SQL syntax.
<p align="center">
